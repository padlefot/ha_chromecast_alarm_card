...
`;let gt=class extends at{constructor(){super(...arguments),this._config={}}setConfig(t){this._config=t}_valueChanged(t){if(!this._config||!this.hass)return;const e=t.target,i={...this._config,[e.configValue]:e.value},s=new CustomEvent("config-changed",{detail:{config:i},bubbles:!0,composed:!0});this.dispatchEvent(s)}_entityChanged(t){const e={...this._config,entity:t.target.value};this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}render(){if(!this.hass)return W;const t=Object.keys(this.hass.states).filter(t=>t.startsWith("switch.")&&void 0!==this.hass.states[t]?.attributes?.alarm_time);return F`
      <div class="editor">
        ...
        >
          ...
          ${t.map(t=>F`<option value=${t} ?selected=${t===this._config.entity}>
