                  ...
                  ${this._editingTarget?F`
                        <div class="target-picker">
                          ...
                          <div class="target-list">
                            ${this._mediaPlayers.map(t=>F`
                                <label class="target-option">
                                  <input
                                    type="checkbox"
                                    .checked=${this._currentTargets.includes(t.id)}
                                    @change=${()=>this._toggleTarget(t.id)}
                                  />
                                  <span>${t.name}</span>
                                </label>
                              `)}
