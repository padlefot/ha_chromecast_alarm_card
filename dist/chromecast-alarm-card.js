...
`;let ft=class extends at{constructor(){super(...arguments),this._config={}}setConfig(t){this._config=t}_valueChanged(t){if(!this._config||!this.hass)return;const e=t.target,i={...this._config,[e.configValue]:e.value},s=new CustomEvent("config-changed",{detail:{config:i},bubbles:!0,composed:!0});this.dispatchEvent(s)}_entityChanged(t){const e={...this._config,entity:t.target.value};this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}render(){if(!this.hass)return F;const t=Object.keys(this.hass.states).filter(t=>t.startsWith("switch.")&&void 0!==this.hass.states[t]?.attributes?.alarm_time);return V`
  ...
  `,t([pt({attribute:!1})],ft.prototype,"hass",void 0),t([ut()],ft.prototype,"_config",void 0),ft=t([ct("chromecast-alarm-card-editor")],ft);const gt=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],_t=["mon","tue","wed","thu","fri","sat","sun"];let $t=class extends at{constructor(){super(...arguments),this._firing=!1}static getConfigElement(){return document.createElement("chromecast-alarm-card-editor")}static getStubConfig(){return{entity:"",show_details:!0}}setConfig(t){if(!t.entity)throw new Error("Please select an alarm entity");this._config=t}getCardSize(){return 3}get _switchEntity(){return this._config.entity}get _baseId(){return this._config.entity.replace("switch.","")}get _sensorEntity(){return`sensor.${this._baseId}_next_fire`}get _snoozeEntity(){return`button.${this._baseId}_snooze`}get _dismissEntity(){return`button.${this._baseId}_dismiss`}get _eventEntity(){return`event.${this._baseId}_event`}_getState(t){return this.hass?.states?.[t]}get _switchState(){return this._getState(this._switchEntity)}get _isEnabled(){return"on"===this._switchState?.state}get _attrs(){return this._switchState?.attributes||{}}updated(t){if(super.updated(t),!t.has("hass"))return;const e=this._getState(this._eventEntity);if(!e)return;const i=t.get("hass"),s=i?.states?.[this._eventEntity];e.state!==s?.state&&"alarm_fired"===e.attributes?.event_type&&(this._firing=!0,this._firingTimeout&&clearTimeout(this._firingTimeout),this._firingTimeout=setTimeout(()=>{this._firing=!1},1e4))}_toggleAlarm(){this.hass.callService("switch",this._isEnabled?"turn_off":"turn_on",{entity_id:this._switchEntity})}_pressSnooze(){this.hass.callService("button","press",{entity_id:this._snoozeEntity})}_pressDismiss(){this.hass.callService("button","press",{entity_id:this._dismissEntity})}_fireAlarm(){this.hass.callService("chromecast_alarm","fire",{entity_id:this._switchEntity})}_stopAlarm(){this.hass.callService("chromecast_alarm","stop",{entity_id:this._switchEntity})}_formatNextFire(){if(!this._isEnabled)return{time:"Off",label:"Alarm disabled"};const t=this._attrs;if(t.is_dismissed_today)return{time:"Dismissed",label:"Until tomorrow"};const e=t.next_fire;if(!e)return{time:"--:--",label:"No upcoming alarm"};const i=new Date(e),s=new Date,r=`${i.getHours().toString().padStart(2,"0")}:${i.getMinutes().toString().padStart(2,"0")}`,n=new Date(s.getFullYear(),s.getMonth(),s.getDate()),o=new Date(i.getFullYear(),i.getMonth(),i.getDate()),a=Math.round((o.getTime()-n.getTime())/864e5);let l;return l=0===a?"Today":1===a?"Tomorrow":i.toLocaleDateString(void 0,{weekday:"short",month:"short",day:"numeric"}),{time:r,label:l}}render(){if(!this._config||!this.hass)return F;if(!this._switchState)return V`<ha-card>
    ...
    `}};$t.styles=mt,t([pt({attribute:!1})],$t.prototype,"hass",void 0),t([ut()],$t.prototype,"_config",void 0),t([ut()],$t.prototype,"_firing",void 0),$t=t([ct("chromecast-alarm-card")],$t),window.customCards=window.customCards||[],window.customCards.push({type:"chromecast-alarm-card",name:"Chromecast Alarm Card",description:"Mushroom-style card for the Chromecast Alarm integration",preview:!0});export{$t as ChromecastAlarmCard};
